  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md relative z-10 border border-indigo-100">
        ...
        <p className="text-gray-500 mb-6 text-center">Join the sound sensing revolution</p>
        ...
        <p className="mt-6 text-sm text-center text-gray-500">
          ...
          <a href="/signin" className="text-indigo-600 font-medium hover:text-indigo-800">
            Login
          </a>
        </p>
...
// Logo, button icon and corner sound icons
const WaveformLogo = () => (
